# Generated by Django 4.2 on 2023-05-25 03:37
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Department',
            fields=[
                ('id', models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='Код Цона')),
                ('name', models.CharField(max_length=72, unique=True, verbose_name='ЦОН')),
                ('address', models.CharField(default='', max_length=126, verbose_name='Адрес местонахождения')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 5, 25)), django.core.validators.MaxValueValidator(datetime.date(2023, 6, 8))], verbose_name='Дата')),
